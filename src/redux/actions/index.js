...
import { FETCH_STATE_DATA, SET_CURRENT_MARKET, FETCH_EXPERTS, SET_CURRENT_EXPERT } from '../actionTypes';
...
export const setCurrentExpert = (expert) => async dispatch => {
  dispatch({ type: SET_CURRENT_EXPERT, payload: expert })
}
